...
import {PropertyHandler} from '../../../../tools/utils/property-handler';
...
export class FlightPanelComponent {
  ...
  searchComplex() {
    ...
    if (this.flightQuery.airportFromObject.cityName && this.flightQuery.airportToObject.cityName && this.flightQuery.airportToObject.cityName !== this.flightQuery.airportFromObject.cityName) {
